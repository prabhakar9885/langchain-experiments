...
from output_parsers.person_parser import person_output_parser


def main(person_info):
    summary_template = """
    Given the information about a person as "{info}. {online_profiles}", observe the following details of the person:
    1. A short summary
    ...
    Use the above observed details, \n
    {format_instructions}
    """
    ...
    chain = summary_prompt_template | llm | person_output_parser
